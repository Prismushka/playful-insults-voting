        ...
        <section className="max-w-4xl mx-auto">
          <header className="text-center mb-12 animate-slide-down">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
              Создавайте уникальные ругательства и голосуйте за лучшие. Каждый голос стоит $1 и помогает определить самые популярные ругательства.
            </p>
            ...
            <div className="space-y-6 animate-fade-in">
              <div className="flex justify-between items-center mb-6">
                ...
                <button
                  ...
                  className="flex items-center p-2 rounded-full hover:bg-secondary transition-all duration-200"
                >
